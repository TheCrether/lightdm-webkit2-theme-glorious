class Sidebar {
	constructor() {
		...
		this._buttonMainScreenSettingsImage = document.querySelector(
			"#button-main-screen-settings-image"
		);
		this._buttonMainScreenPowersImage = document.querySelector(
			"#button-main-screen-powers-image"
		);
	...
	showSidebar() {
		...
		this._buttonMainScreenSettingsImage.classList.add(
			"button-main-screen-blur"
		);
	...
	hideSidebar() {
		...
		this._buttonMainScreenSettingsImage.classList.remove(
			"button-main-screen-blur"
		);
		this._buttonMainScreenPowersImage.classList.remove(
			"button-main-screen-blur"
		);
		this._sidebarVisible = false;
	}
